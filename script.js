...
ScrollReveal().reveal('.home-img, .tools-container,.project-box,.contact form', { origin:'bottom' });
...
function sendEmail(){
    Email.send({
        Host : "smtp.gmail.com",
        Username : "advika867@gmail.com",
        Password : "PrashantiAnirudh@12",
        To : 'iavturiprashanti@gmail.com',
